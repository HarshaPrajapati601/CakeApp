...
export class CakeGalleryComponent implements OnInit {
  ...
  cakesDetails:any=[
    {name:'Choclate ',path:'../../assets/images/moms-cake/CakeImg.jpg',amount:'Rs 300',description:'choclate decorated cake , Half kg' },
    {name:'Choclate ',path:'../../assets/images/moms-cake/CakeImg-1.jpg',amount:'Rs 300',description:'choclate cherry cake , Half kg' },
